  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        login(user || { id: 'mock-user-id', email: formData.email });

        // Redirect to tasks dashboard after successful login
        router.push('/tasks');
      } else {
        // Try to get more specific error message
        const errorMessage = result.error || result.message || result.detail || 'Failed to sign in';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{' '}
          <Link href="/signup" className="font-medium text-primary-500 hover:text-green-500">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <a href="#" className="font-medium text-primary-500 hover:text-green-500">
